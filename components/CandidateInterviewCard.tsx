                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex gap-2 w-full">
                        <Button className="btn-primary flex-1">
                            ...
                            >
                                {hasFeedback ? "Check Feedback" : status === "in-progress" ? "Continue Interview" : "Start Interview"}
                            </Link>
                        </Button>

                        {(hasFeedback || status === "in-progress") && (
                            <button
                                type="button"
                                onClick={async (e) => {
                                    e.preventDefault();
                                    ...
                                    const confirmMessage = hasFeedback 
                                        ...
                                        : "Are you sure you want to delete this in-progress interview? This action cannot be undone.";
                                    ...
                                    try {
                                        const endpoint = hasFeedback && feedbackId
                                            ? `/api/candidate/delete-feedback/${feedbackId}`
                                            : `/api/candidate/delete-interview/${interviewId}`;
                                        ...
                                        if (res.ok && data.success) {
                                            toast.success(hasFeedback ? "Feedback deleted successfully" : "Interview deleted successfully");
