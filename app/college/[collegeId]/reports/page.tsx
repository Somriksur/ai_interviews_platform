...
export default function CollegeReportsPage({
  ...
  useEffect(() => {
    fetchReports();
  }, [collegeId, studentFilter, driveFilter, startDate, endDate]);
  ...
  const fetchReports = async () => {
    try {
      ...
      const response = await fetch(`/api/colleges/${collegeId}/reports?${params.toString()}`);
      if (response.ok) {
  ...
  const handleExport = async (format: 'csv' | 'pdf') => {
    ...
    try {
      ...
      if (format === 'csv') {
        ...
        a.href = url;
        a.download = `college_reports_${Date.now()}.csv`;
        a.click();
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            View interview performance reports for your students
          </p>
        </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Organization: {report.organization?.name} • Drive: {report.drive?.name}
                        </p>
                      </div>
