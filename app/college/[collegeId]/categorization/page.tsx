...
export default function CollegeCategorizationPage({
  params,
}: {
  ...
  const fetchAndCategorizeStudents = async () => {
    try {
      // Fetch all reports for this college
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold">Student Placement Potential</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Your students categorized by placement potential and salary bands
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-green-50 dark:bg-green-900/20 rounded-lg shadow p-6">
            ...
            <div className="text-xs text-gray-500 mt-1">
              {totalStudents > 0 ? Math.round((categorized.high.length / totalStudents) * 100) : 0}% of students
            </div>
          </div>
          <div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg shadow p-6">
            ...
            <div className="text-xs text-gray-500 mt-1">
              {totalStudents > 0 ? Math.round((categorized.medium.length / totalStudents) * 100) : 0}% of students
            </div>
          </div>
          <div className="bg-gray-50 dark:bg-gray-700 rounded-lg shadow p-6">
            ...
            <div className="text-xs text-gray-500 mt-1">
              {totalStudents > 0 ? Math.round((categorized.low.length / totalStudents) * 100) : 0}% of students
            </div>
          </div>
        </div>
