...
export default function OrganizationStudentsPage({
  ...
  const fetchStudents = async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/organization/${orgId}/students`);
      if (response.ok) {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2">All Students</h1>
          <p className="text-gray-600 dark:text-gray-400">
            View students across all colleges in your organization
          </p>
        </div>
